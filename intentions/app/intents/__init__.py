...
from .schemas import IntentCreateRequest, IntentResponse, IntentUpdateDescriptionRequest, IntentUpdateNameRequest
from .service import create_intent, get_intent, update_intent_description, update_intent_name
