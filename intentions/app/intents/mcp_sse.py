"""
Legacy MCP HTTP+SSE transport compatibility at /mcp for clients that still
use the deprecated SSE workflow.
"""
...
async def _sse_stream(session: _SseSession):
    ...
    """
    try:
        yield f"event: endpoint\ndata: /mcp/message?sessionId={session.session_id}\n\n"
        while True:
            try:
